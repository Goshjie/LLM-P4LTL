    ...
    apply {
        ...
        if(standard_metadata.ingress_port == 0){
              ...
              if(hdr.tcp.isValid())
                ...
                // for assertion : when applying tunnel, egress port should be equal to the count value
                        count.read(temp4Assert,(bit<32>)0);
                        @assert[(bit<32>)standard_metadata.egress_spec == temp4Assert] {}
            	}
